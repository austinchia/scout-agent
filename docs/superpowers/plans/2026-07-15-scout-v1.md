...
**Tech Stack:** Python 3.11+, uv, FastAPI, Pydantic v2, psycopg 3, Google Gen AI Python SDK (`google-genai`: gemini-2.5-flash, gemini-2.5-flash-lite, gemini-embedding-001), Tavily Python SDK (`tavily-python`), Neon Postgres + pgvector, React + Vite + Tailwind v4, pnpm (via Corepack).
